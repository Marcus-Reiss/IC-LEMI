...
> > ***Output:*** nenhum
> 
> - Chama a função [Obtém pressão - M3](#obtém-pressão---m3) 
> 
...
> 
> - Chama a função [Obtém temperatura](#obtém-temperatura) 
> 
...
> > ***Output:*** nenhum
> 
> - Chama as funções [Verifica válvulas 2](#verifica-válvulas-2) e [Verifica compressores](#verifica-compressores)
...
> > ***Output:*** nenhum
> 
> - Chama as funções [Verifica válvulas 2](#verifica-v%C3%A1lvulas-2), [Verifica válvulas 3](#verifica-válvulas-3) e [Verifica compressores](#verifica-compressores)
...
> 
> - Chama as funções [OPERAÇÃO - M1](#operação---m1), [OPERAÇÃO - M2](#operação---m2), [OPERAÇÃO - M3](#operação---m3) e [Obtém pressão](#obtém-pressão)
...
> > ***Output:*** nenhum
> 
> - Chama as funções [Finaliza operação](#finaliza-operação) e [Atualiza índices](#atualiza-índices)
...
> 
> - Chama as funções [Obtém pressão](#obtém-pressão), [Monitora pressão](#monitora-pressão), [Pressão crescente](#pressão-crescente) e [Pressão decrescente](#pressão-decrescente)
...
> > ***Output:*** nenhum
> 
> - Chama as funções [Aciona válvulas - M1 e M2](#aciona-válvulas-m1-e-m2) e [Aciona compressores](#aciona-compressores)
...
> > ***Output:*** nenhum
> 
> - Chama a função [Finaliza operação - M3](#finaliza-operação-m3)
...
> 
> - Chama as funções [Aciona válvulas - M3](#aciona-v%C3%A1lvulas-m3), [Atinge pressão de eq](#atinge-pressão-de-eq), [Calcula média - M3](#calcula-média---m3), [Aciona compressores](#aciona-compressores), [Atinge Plim](#atinge-plim) e [Finaliza operação - M3](#finaliza-operação-m3)
...
> 
> - Chama as funções [Obtém pressão](#obtém-pressão), [Calcula derivada](#calcula-derivada) e [Calcula média móvel](#calcula-média-móvel)
> 
...
> 
> - Quando "em operação", chama [M1 - Operação iniciada](#m1---operação-inicada) e [Obtém pressão de saída](#obtém-pressão-de-saída)
> 
> - Quando "saindo da operação", chama [M1 - Operação finalizada](#m1---operação-finalizada) e pode chamar [Protocolo de Emergência](#protocolo-de-emergência)
...
> 
> - Quando "saindo da operação", chama [M2 - Operação finalizada](#m2---opera%C3%A7%C3%A3o-finalizada) e pode chamar [Protocolo de Emergência](#protocolo-de-emergência)
...
> 
> - Quando "saindo da operação", chama [M3 - Operação finalizada](#m3---opera%C3%A7%C3%A3o-finalizada) e pode chamar [Protocolo de Emergência](#protocolo-de-emergência)
...
> 
> - Pode chamar a função [Verifica válvulas 1](#verifica-válvulas-1)
...
> 
> - Pode chamar a função [Verifica válvulas 2](#verifica-v%C3%A1lvulas-2) e a [Atualiza índices](#atualiza-índices)
...
> > ***Output:*** nenhum
> 
> - Chama a função [Aciona válvulas - M1 e M2](#aciona-válvulas---m1-e-m2)
...
> > ***Output:*** nenhum
> 
> - Chama a função [Desliga válvulas - M1 e M2](#desliga-válvulas---m1-e-m2)
...
> > ***Output:*** nenhum
> 
> - Chama a função [Desliga válvulas - M3](#desliga-válvulas---m3)
